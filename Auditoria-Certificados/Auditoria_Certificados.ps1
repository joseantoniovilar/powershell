...
$CredencialesDisco = (New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList "$RutaFichero",(ConvertTo-SecureString "clave" -AsPlainText -Force))
